...
$title = "Update Siswa - SMK N 1 PLUPUH";
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item active">Update Siswa</a>
                </li>
            </ol>
                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <input type="nama" name="nama" required class="form-control border-0 border-bottom ps-2 " id="nama" value="<?= $data['nama'] ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                            ...
                            <div class="col-4 text-center px-5">
                                ...
                                <img src="../asset/image/<?= $data['foto'] ?>" alt="" class="mb-3 rounded-circle" width="70%">
