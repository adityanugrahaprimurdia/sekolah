...
$title = "Nilai Ujian - SMK N 1 PLUPUH";
...
if ($msg == 'LULUS') {
    $alert = '<div class="alert alert-success alert-dismissible" style"display: none;" id="LULUS" role="alert">
    <i class="fa-solid fa-circle-check"></i> Selamat siswa dengan NIS :  ' . $nis . 'berhasil lulus ujian
  </div>';
}
if ($msg == 'GAGAl') {
    $alert = '<div class="alert alert-danger alert-dismissible" style"display: none;" id="GAGAl" role="alert">
    <i class="fa-solid fa-circle-check"></i> Siswa dengan NIS : ' . $nis . 'gagal lulus ujian
  </div>';
}
...
<div id="layoutSidenav_content">
            ...
            <div class="row">
                <div class="col-7">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="ujian.php">Ujian</a>
                        </li>
                    ...
                    <div class="col-4">
                        <div class="card">
                            <div class="card-header">
                                <i class="fa-solid fa-plus"></i> Data Perserta Ujian
                            </div>
                            <div class="card-body">
    ...
    <script>
        ...
        // script untuk menjalankan ajax nya
